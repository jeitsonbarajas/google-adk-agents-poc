...
# Local packages to upload into the sandbox so imports work at runtime
...
class VertexAdkApp(reasoning_engines.AdkApp):
    """AdkApp that configures Vertex AI env vars inside the sandbox on startup."""
...
def build_app() -> VertexAdkApp:
    """Wrap the orquestador in VertexAdkApp for Agent Engine."""
    return VertexAdkApp(
